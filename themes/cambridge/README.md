# Jurassic Hak5 Theme (Work in Progress)
...
## Visual Style
* **Boot Screen:** 16-bit pixel art inspired by the Jurassic Park main gate.
* **Main Dashboard:** High-contrast Cyan & Magenta Unix accents against dark background.
